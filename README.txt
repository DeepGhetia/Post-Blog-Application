...
4. users folder is the second application under djangoblog project and users folder has admin.py, apps.py, models.py(for database connection class), views.py , forms.py(database classes can be easily accessed using this file), and signals.py(in order to get the profile of the user after login i.e retrieving from the databse).
